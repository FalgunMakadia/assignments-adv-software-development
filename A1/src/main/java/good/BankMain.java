...
public class BankMain {
	...
	public static void main(String[] args) {
		...
		double ciAmount = i.compoundInterestCalculator(600000, 7.8, 5);
		System.out.println("Earned Compound Interest Amount:" + ciAmount);

		double fd = i.fixedDepositInterestCalculator(800000, 4.5);
		System.out.println("Earned Fixed Deposit Interest:" + fd);

		double hl_emi = hl.homeLoanEmiCalculator(1400000, 12);
		...
		double cl_emi = cl.carLoanEmiCalculator(600000, 5);
